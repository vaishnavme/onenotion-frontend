...
export const Navbar = () => {
    ...
    const toggleBtnHandler = () => setToggle((prevState) => !prevState);
    ...
    return (
        <React.Fragment>
            <header className="fixed top-0 left-0 w-full shadow bg-white px-4 z-10 md:hidden">
                <div className="flex items-center justify-between h-16">
                    ...
                    >
                        <i
                            className={
                                toggle ? `bx bx-x` : `bx bx-menu-alt-right`
                            }
                        ></i>
                    </div>
                </div>
            ...
            <div
                className={
                    toggle
                        ? `${navStyle} left-0 w-64`
                        : `${navStyle} -left-full w-52 md:left-0 pt-5 px-6`
                }
            >
                <nav className="flex justify-between flex-col h-full pb-12 overflow-auto">
                    <div>
                        <NavLink
                            to="/"
                            className="mb-10 font-semibold flex items-center"
                        >
                    ...
                    <button
                        ...
                        className="flex items-center p-1 rounded-lg hover:text-black hover:bg-white hover:shadow-md"
                    >
...
const navStyle =
    'fixed top-0 h-full pt-4 px-4 pb-0 shadow bg-blue-100 z-50 overflow-hidden transition-all duration-500 ease-in-out';
