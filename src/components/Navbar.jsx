                    ...
                    <div>
                        ...
                        <div className="grid gap-y-10 mt-32">
                            <div className="grid gap-y-6">
                                <NavLink to="/create" activeStyle={activeColor} className="flex items-center text-gray-500 pt-1">
                                ...
                                <NavLink to="/shared" activeStyle={activeColor} className="flex items-center text-gray-500 p-1">
                                    <i className='bx bx-intersect text-2xl p-1'></i>
                                    <span className="text-base whitespace-nowrap ml-4">Shared</span>
                                </NavLink>
                                <NavLink to="/account" activeStyle={activeColor} className="flex items-center text-gray-500 p-1">
...
const navStyle = "fixed top-0 h-full pt-4 px-4 pb-0 shadow bg-gray-100 z-10 overflow-hidden transition-all duration-500 ease-in-out"