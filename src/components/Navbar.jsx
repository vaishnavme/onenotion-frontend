...
export const Navbar = () => {
    ...
    return (
        <React.Fragment>
            <header className="fixed top-0 left-0 w-full shadow bg-gray-800 px-4 z-10 md:hidden">
            ...
            <div className={toggle ? `${navStyle} left-0 w-64` : `${navStyle} -left-full w-52 md:left-0 pt-5 px-6`}>
                <nav className="flex justify-between flex-col h-full pb-12 overflow-auto">
                    <div>
                        <NavLink to="/" className="mb-10 font-semibold flex items-center text-white">
                        ...
                        <div className="grid gap-y-10 mt-32">
                            <div className="grid gap-y-6">
                                <NavLink to="/new" activeStyle={activeColor} className="flex items-center text-gray-200 p-1" end>
                                    <i className="bx bx-pencil text-2xl p-1"></i>
                                    <span className="text-base whitespace-nowrap ml-4">Create New</span>
                                </NavLink>
                                <NavLink to="/" activeStyle={activeColor} className="flex items-center text-gray-200 p-1" end>
                                    <i className="bx bx-notepad text-2xl p-1"></i>
                                    <span className="text-base whitespace-nowrap ml-4">All Notes</span>
                                </NavLink>
                                <NavLink to="/shared" activeStyle={activeColor} className="flex items-center text-gray-200 p-1">
                                    <i className='bx bx-intersect text-2xl p-1'></i>
                                    <span className="text-base whitespace-nowrap ml-4">Shared</span>
                                </NavLink>
                                <NavLink to="/account" activeStyle={activeColor} className="flex items-center text-gray-200 p-1">
                    ...
                    <NavLink to="/" className="flex items-center p-1 text-gray-200 rounded-lg hover:text-black hover:bg-white hover:shadow-md">
...
const navStyle = "fixed top-0 h-full pt-4 px-4 pb-0 shadow bg-gray-800 z-10 overflow-hidden transition-all duration-500 ease-in-out"